    ...
    predictionDiv.innerHTML = `
      <div class="prediction-content">
        ...
        <div class="prediction-text">
          <span style="color:#2596be" class="winner">${winningTeam}</span> is predicted to win with an average of
          <span style="color:#2596be" class="winner">${homeScore > awayScore ? homeScore : awayScore}</span> points and the average score predicted of
          <span style="color:#2596be" class="winner">${homeScore} - ${awayScore}</span> points, 
          total of <span style="color:#2596be" class="winner">${totalScore}</span> points
